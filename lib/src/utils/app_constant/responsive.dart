...
/// Returns value of the screen [height]
kHeight(BuildContext context) => MediaQuery.of(context).size.height;

/// Returns value of the screen [width]
kWidth(BuildContext context) => MediaQuery.of(context).size.width;
